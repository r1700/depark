...
export class reservedparking extends Model {
  public id!: number;
  public baseuser_id!: number;
...
reservedparking.init(
  {
    id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    baseuser_id: { type: DataTypes.INTEGER, allowNull: false },
    parking_number: { type: DataTypes.INTEGER, allowNull: false },
...
export class vehiclemodels extends Model {
  ...
  public make!: string;
  public model!: string;
  public year_range!: object | null; // JSONB
  public dimensions!: object | null; // JSONB
...
vehiclemodels.init(
  {
    ...
    year_range: { type: DataTypes.JSONB, allowNull: true },
    dimensions: { type: DataTypes.JSONB, allowNull: true },
    source: { type: DataTypes.INTEGER, allowNull: true },
    created_at: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
    updated_at: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
  },
  {
