...
import  {parkingconfigurations,vehicles,baseuser, User, ParkingSession} from '../../model/dataBaseModels/model'; 
...
// הוספת baseuser
// async function addbaseuserData(
//   email: string,
//   first_name: string,
//   last_name: string
// ) {
//   try {
//     const newbaseuser = await baseuser.create({
//       email,
//       first_name,
//       last_name,
//       created_at: new Date(),
...
//     return newbaseuser;
//   } catch (error) {
//     console.error('Error while adding baseuser:', error);
//     throw error;
//   }
// }
...
// הוספת Vehicle (כבר קיימת - מעודכנת)
