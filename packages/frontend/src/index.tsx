...
import AdmainConfigResevedparhing from "./admin/components/AdmainConfigReservedparking";
      ...
      { path: 'admin', children: [
          ...
          { index: true, element: <AdminIndexRedirect /> }, // /admin -> redirect logic
          {
            ...
            children: [
              ...
              { path: 'admin-config-reservedparking', element: <AdmainConfigResevedparhing /> },
