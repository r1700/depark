...
import ParkingOccupiedCount from './admin/components/adminDashboard/ParkingStatus';
import FeedbackQuestions from './admin/components/feedbackQuestions/FeedbackQuestions';
import FeedbackAnswersReports from './admin/components/FeedbackAnswersReports/FeedbackAnswersReports';
      ...
      { index: true, element: <LoginPage /> },
      {
        path: 'admin', children: [
          ...
          { index: true, element: <AdminIndexRedirect /> }, // /admin -> redirect logic
          {
            ...
            children: [
              {path: 'feedback', element: <FeedbackQuestions /> },
              ...
              { path: 'vehicles', element: <VehiclesPage /> },
              {
                path: 'reports',
                children: [
                  { path: 'parking-occupancy', element: <ParkingOccupiedCount /> },
                  { path: 'parking-stats', element: <ParkingStatsPage /> },
                  { path: 'surface-stats', element: <SurfaceStatsPage /> },
                  {path: 'feedback-answers', element: <FeedbackAnswersReports /> },
                ]
              },
