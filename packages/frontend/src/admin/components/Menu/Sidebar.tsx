...
const Sidebar: React.FC<SidebarProps> = ({ user, onLogout }) => {
  ...
  const menuItems: Array<{
    ...
    { text: 'Vehicles', icon: <DirectionsCarIcon />, path: '/layout/vehicles', allowed: ['admin', 'hr'] }, // שניהם
    {
      ...
      subMenu: [
        { text: 'Report 1', path: '/layout/reports/report1', allowed: ['admin'] }, // רק מנהל
        { text: 'Report 2', path: '/layout/reports/report2', allowed: ['admin', 'hr'] }, // שניהם
        { text: 'Report 3', path: '/layout/reports/report3', allowed: ['hr'] }, // רק HR
      ],
    },
  ];
