...
import { Box, Typography, MenuItem, Select, InputLabel, FormControl, SelectChangeEvent, Autocomplete, TextField } from '@mui/material';
            ...
            <div className="search-bar-wrapper">
                ...
                >
                    <Autocomplete
                        ...
                        disabled={!!employeeId}
                    />
                    <button type="submit" className="submit-btn small-btn" disabled={!licensePlate || !!employeeId}>
                        Search
                    </button>
                </form>
                <form
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => (
                            <TextField
                                ...
                                variant="outlined"
                                inputProps={{ ...params.inputProps, maxLength: 5, inputMode: 'numeric', pattern: '[0-9]*', 'aria-label': 'Enter employee ID' }}
                                disabled={!!licensePlate}
                            />
                        )}
                        disabled={!!licensePlate}
                    />
                    <button type="submit" className="submit-btn small-btn" disabled={!employeeId || !!licensePlate}>
                        Search
                    </button>
                </form>
